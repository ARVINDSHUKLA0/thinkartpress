...
//                         </div>
//                         <div>
//                             <button className='my-2 w-100 text-capitalize border-0 rounded-2 py-1  ' style={{ backgroundColor: "#F7BC1D" }} data-bs-toggle="modal"
//                                 data-bs-target="#participateModal">click</button>
//                         </div>
...
//                   Now be a part of an international art journal —
//                   Simply participate in an international competition and get a
//                   chance to showcase your talent here!
//                 </h4>
//                 <p className="text-white fs-15 pt-2 ps-lg-5">
//                   <strong>Rules:</strong> Whatever you have made, simply take a
//                   photo of it and mail it to <br />
//                   <a
...
//                 </div>
//                 <div className="mb-3">
//                   <label className="form-label fw-bold">Competitions</label>
//                   <input
//                     type="text"
//                     className="form-control"
//                     placeholder="e.g. Preschool Category"
//                     required
//                   />
//                 </div>
//                 <button
...
//   const [expanded, setExpanded] = useState(null);
//   const [selectedImage, setSelectedImage] = useState(null);
//   const [selectedCompetition, setSelectedCompetition] = useState(""); // ✅ new state
...
//                 data-bs-toggle="modal"
//                 data-bs-target="#participateModal"
//                 onClick={() => setSelectedCompetition(cat.title)} // ✅ sets competition title
//               >
//                 Click
//               </button>
//             </div>
...
//                     type="text"
//                     className="form-control"
//                     value={selectedCompetition} // ✅ auto-filled
//                     readOnly
//                   />
//                 </div>
...
//     emailjs
//       .send(
//         "service_mqw0uht", // ✅ Your Service ID
//         "template_288g63x", // ✅ Your Template ID
//         dataToSend,
//         "Lyg3uXNiS-emPEY5X" // ✅ Your Public Key
//       )
//       .then(
//         (result) => {
...
const Page = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_mqw0uht", // ✅ Service ID
        "template_288g63x", // ✅ Template ID
        dataToSend,
        "Lyg3uXNiS-emPEY5X" // ✅ Public Key
      )
      .then(
        (result) => {
          console.log("Email sent:", result.text);
